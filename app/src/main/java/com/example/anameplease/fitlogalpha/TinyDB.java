...
public class TinyDB {
    ...
    public ArrayList<Notes> getListObject(String key, Class<Notes> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Notes> objects =  new ArrayList<Notes>();

    	for(String jObjString : objStrings){
    		Notes value  = gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public <T> T getObject(String key, Class<Notes> classOfT){

        String json = getString(key);
        Notes value = new Gson().fromJson(json, classOfT);
        if (value == null)
    ...
    public void putObject(String key, Notes obj){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	putString(key, gson.toJson(obj));
    }
    public void putListObject(String key, ArrayList<Notes> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
